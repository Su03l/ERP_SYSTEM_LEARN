...
#[Fillable(['name', 'email', 'password', 'role', 'status', 'job_title', 'department', 'phone', 'salary', 'national_id', 'join_date', 'bank_iban', 'address', 'emergency_contact', 'gender', 'birth_date', 'avatar'])]
