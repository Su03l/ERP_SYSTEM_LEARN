...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(\App\Http\Middleware\AdminMiddleware::class)->group(function () {
        ...
        // تقييم الأداء
        Route::get('/performance-evaluations', [PerformanceEvaluationController::class, 'index'])->name('performance.index');
        Route::get('/performance-evaluations/lookup', [PerformanceEvaluationController::class, 'lookup'])->name('performance.lookup');
        Route::post('/performance-evaluations', [PerformanceEvaluationController::class, 'store'])->name('performance.store');
    });
